...
class SmartWebSocketV2(object):
    ...
    def _on_close(self, wsapp, close_status_code=None, close_reason=None):
        self.on_close(wsapp, close_status_code, close_reason)
        logger.info(f"WebSocket connection closed. Status code: {close_status_code}, Reason: {close_reason}")
    ...
    def on_close(self, wsapp, close_status_code=None, close_reason=None):
        pass
